...
def check_levels_101_500():
    ...
    for level in range(101, 501):
        ...
        try:
            ...
            needs_adjustment = ratio > 4.3
            
            new_move_count = move_count
            new_display_steps = display_steps
            
            if needs_adjustment:
                new_move_count, new_display_steps = calculate_required_move_count(display_targets, 4.3)
            ...
            status = "YES" if needs_adjustment else "NO"
    ...
    print(f"\n找到 {len(levels_to_adjust)} 个关卡的比值大于4.3")
    return levels_to_adjust

if __name__ == "__main__":
    levels_to_adjust = check_levels_101_500()
